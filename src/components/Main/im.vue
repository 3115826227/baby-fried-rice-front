...
export default {
  ...
  methods: {
    ...
    getOperators () {
      var that = this
      this.$axios.get('/api/im/session/operator', {
        headers: {
          token: sessionStorage.getItem('token')
        }
      }).then(function (response) {
    ...
    getSessionDetail (sessionId) {
      var that = this
      this.$axios.get('/api/im/session/detail?session_id=' + sessionId, {
        headers: {
          token: sessionStorage.getItem('token')
        }
      }).then(function (response) {
    ...
    deleteOperator (operatorId) {
      var that = this
      this.$axios.delete('/api/im/session/operator?operator_id=' + operatorId, {
        headers: {
          token: sessionStorage.getItem('token')
        }
      }).then(function (response) {
    ...
    getFriends () {
      var that = this
      this.$axios.get('/api/im/session/friend', {
        headers: {
          token: sessionStorage.getItem('token')
        }
      }).then(function (response) {
